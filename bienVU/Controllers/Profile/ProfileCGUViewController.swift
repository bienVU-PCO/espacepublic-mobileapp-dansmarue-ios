...
class ProfileCGUViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let cguText = Constants.LabelMessage.cguText1 + "<br><br>" + Constants.LabelMessage.cguText2 + "<br>" + Constants.LabelMessage.cguText3 + "<br><br>" + Constants.LabelMessage.cguText4 + "<br><br>" + Constants.LabelMessage.cguText5 + "<br><br>" + Constants.LabelMessage.cguText6 + "<br><br>" + Constants.LabelMessage.cguText7
