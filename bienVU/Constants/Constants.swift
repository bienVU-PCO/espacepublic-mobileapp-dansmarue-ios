...
struct Constants {
    ...
    struct LabelMessage {
        ...
        static let cgu = "CGU"
        static let cguText1 = "Les présentes dispositions ont pour objet de définir les conditions d’accès et d’utilisation du site Bien VU géré par l’Etablissement Public Territorial Plaine Commune.<br><br>En  consultant le site, l’application mobile et les informations qui y figurent, l’utilisateur accepte, sans aucune réserve, les conditions mentionnées ci-après."
        static let cguText2 = "I. Présentation générale<br>L’application  BienVU  vise  à  améliorer  la  qualité  de  l’espace  public  du territoire  en favorisant  la  synergie  entre  les  usagers  de  l’espace  public  et  les  services  techniques territoriaux et leurs partenaires.<br><br>L’application BienVU est conçue pour fonctionner sur le territoire de Plaine Commune. Elle utilise certaines fonctionnalités de votre smartphone (GPS et connexion 3G/4G) qui nécessitent une bonne connexion.<br><br>Afin d’assurer la remontée rapide, précise, fiable d’une anomalie sur l’espace public et faciliter sa prise en charge par les services territoriaux de Plaine Commune et leurs partenaires, il est demandé à l’utilisateur :<br>"
